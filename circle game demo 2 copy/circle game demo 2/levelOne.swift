...
class levelOne: SKScene, SKPhysicsContactDelegate {
    ...
    func gameStart (){
        ...
        circle.run(SKAction.repeatForever(SKAction.rotate(byAngle: CGFloat.pi * 2.0, duration: 10 )), withKey: "rotatecircle")
       ...
       //circle2.run(SKAction.repeatForever(SKAction.rotate(byAngle: -CGFloat.pi * 2.0, duration: 10)), withKey: "rotatecircle2")
        ...
        //circle3.run(SKAction.repeatForever(SKAction.rotate(byAngle: CGFloat.pi * 2.0, duration: 10)), withKey: "rotatecircle3")
        ...
        //circle4.run(SKAction.repeatForever(SKAction.rotate(byAngle: -CGFloat.pi * 2.0, duration: 10)), withKey: "rotatecircle4")
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        ...
        if collision1 == targetCategory {
            ...
            perform(#selector(youWon), with: nil, afterDelay: 0.5)
            
        }
        else {
            
           perform(#selector(youLost), with: nil, afterDelay: 1)
